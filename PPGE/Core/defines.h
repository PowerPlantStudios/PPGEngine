...
#define PPGE_BIND_CLASS_METHOD_ARG_COUNT_2(function) std::bind(&function, this, std::placeholders::_1, std::placeholders::_2)
#define PPGE_BIND_CLASS_METHOD_ARG_COUNT_3(function) std::bind(&function, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3)
#define PPGE_BIND_CLASS_METHOD_ARG_COUNT_4(function) std::bind(&function, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4)
	...
	#define PPGE_ASSERT(exp, ...) { if(!(exp)) { PPGE_ERROR("Assertion Failed : {0}", __VA_ARGS__); PPGE_BREAKPOINT(); } }
	#define APP_ASSERT(exp, ...)  { if(!(exp)) { APP_ERROR("Assertion Failed : {0}", __VA_ARGS__);  PPGE_BREAKPOINT(); } }
