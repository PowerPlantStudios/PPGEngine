...
#define PPGE_INPUT_EVENT_CATEGORY(category)                                                                            \
    virtual int GetInputEventCategory() const override                                                                 \
    {                                                                                                                  \
        return category;                                                                                               \
    }
#define PPGE_INPUT_EVENT_CLASS(type)                                                                                   \
    static InputEventType RetreiveInputEventTypeEnum()                                                                 \
    {                                                                                                                  \
        return InputEventType::type;                                                                                   \
    }                                                                                                                  \
    virtual InputEventType GetInputEventType() const override                                                          \
    {                                                                                                                  \
        return RetreiveInputEventTypeEnum();                                                                           \
    }                                                                                                                  \
...
class PPGE_API InputEvent
{
  public:
    ...
    bool IsInCategory(InputEventCategoryBit category)
    {
        return GetInputEventCategory() & static_cast<int>(category);
    }
...
template <typename T, typename F> bool DispatchInputEvent(const InputEvent &e, const F &func)
{
