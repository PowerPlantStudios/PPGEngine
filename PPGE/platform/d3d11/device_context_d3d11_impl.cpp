                                              ...
                                              const uint64_t offsets[])
{
    ...
    m_d3d11_device_context_ptr->IASetVertexBuffers(0, num_buffers, m_bound_d3d11_vertex_buffers_ptr.data(),
                                                   m_bound_d3d11_vertex_buffer_strides.data(),
                                                   m_bound_d3d11_vertex_buffer_offsets.data());
}
...
#define BIND_SHADER(SHADER_NAME, SHADER_NAME_SHORT, SHADER_IDX)                                                        \
    ...
    {                                                                                                                  \
        ...
        m_d3d11_device_context_ptr->##SHADER_NAME_SHORT##SetShader(d3d11_##SHADER_NAME_SHORT##_shader, nullptr, 0);    \
...
void DeviceContextD3D11Impl::ClearRenderTarget(const std::shared_ptr<PPGETextureView> &p_view, float r, float b,
                                               float g, float a)
{
}
