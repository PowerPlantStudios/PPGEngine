...
#include "display_system_macos.h"
...
namespace PPGE
{
    ...
    DisplaySystemMacos::DisplaySystemMacos(const DisplaySystemProps& props)
    {
        Init(props);
    }


    DisplaySystemMacos::~DisplaySystemMacos()
    {
        Shutdown();
    }

    void DisplaySystemMacos::OnUpdate()
    {
        glfwPollEvents();
        glfwSwapBuffers(m_window);
    }

    void* DisplaySystemMacos::GetNativeDisplayPtr() const
    {
        return m_window;
    }

    bool DisplaySystemMacos::GetWindowFlag(WindowFlags flag) const
    {
        bool b_value = false;
    ...
    void DisplaySystemMacos::SetWindowFlag(WindowFlags flag, bool b_value)
    {
        switch (flag)
        {
            case WindowFlags::ALWAYS_ON_TOP:
    ...
    void DisplaySystemMacos::SetWindowMode(WindowModes mode)
    {
        switch (mode)
        {
    ...
    bool DisplaySystemMacos::IsVsyncEnabled() const
    {
        return m_props.vSync;
    }

    void DisplaySystemMacos::SetVsync(bool b_value)
    {
    ...
    bool DisplaySystemMacos::IsMinimized() const
    {
        return m_props.minimized;
    }

    bool DisplaySystemMacos::IsMaximized() const
    {
        return m_props.minimized;
    }

    DisplaySystemMacos::InputEventCallback DisplaySystemMacos::InputEventCallbackFunctionPtr() const
    {
        return m_props.InputEventCallback;
    }

    void DisplaySystemMacos::SetInputEventCallbackFunctionPtr(InputEventCallback callback)
    {
        m_props.InputEventCallback = callback;
    }

    DisplaySystemMacos::ApplicationEventCallback DisplaySystemMacos::ApplicationEventCallbackFunctionPtr() const
    {
        return m_props.ApplicationEventCallback;
    }

    void DisplaySystemMacos::SetApplicationEventCallbackFunctionPtr(ApplicationEventCallback callback)
    {
        m_props.ApplicationEventCallback = callback;
    }

    std::string DisplaySystemMacos::Title() const
    {
        return m_props.title;
    }

    void DisplaySystemMacos::Title(const std::string& title)
    {
        glfwSetWindowTitle(m_window, title.c_str());
        m_props.title = title;
    }

    uint32_t DisplaySystemMacos::Height() const
    {
        return m_props.height;
    }

    void DisplaySystemMacos::SetHeight(uint32_t height)
    {
    ...
    uint32_t DisplaySystemMacos::Width() const
    {
        return m_props.width;
    }

    void DisplaySystemMacos::SetWidth(uint32_t width)
    {
        if (!glfwGetWindowAttrib(m_window, GLFW_MAXIMIZED))
        {
            m_props.width = width;
    ...
    void DisplaySystemMacos::Init(const DisplaySystemProps& props)
    {
        ...
        {
            DisplaySystemMacosProps& win_props = *(DisplaySystemMacosProps*)glfwGetWindowUserPointer(window);
    ...
    void DisplaySystemMacos::Shutdown()
    {
