...
namespace PPGE
{
    class PPGE_API DisplaySystemMacos : public DisplaySystem
    {
        public:

        DisplaySystemMacos(const DisplaySystemProps& props);

        virtual ~DisplaySystemMacos();
        ...
        struct DisplaySystemMacosProps
        {
        ...
        GLFWwindow* m_window;
        DisplaySystemMacosProps m_props;
    };
}
